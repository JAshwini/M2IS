...
<body style="background-color:lightgray">
	...
	<div class="container col-lg-5 border p-5" style="margin-top: 5%;background-color: white">
		<div class="form-group row">
		  ...
		  <div class="col-lg-9"><input type="text" class="form-control" id="username"></div>
		</div>
		<div class="form-group row">
		  <div class="col-lg-3"><label for="usr">Password:</label></div>
		  <div class="col-lg-9"><input type="password" class="form-control" id="password"></div>
		</div>
		<div class="col-lg-12"><center><button type="button" class="btn-primary">Login</button></center></div>
	</div>
